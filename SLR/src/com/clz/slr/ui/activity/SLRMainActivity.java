 ...
 * @author guolin
 */
public class SLRMainActivity extends FragmentActivity {
	 ...
	 * 发现界面的Fragment
	 */
	private ShareFragment foundFragment;

	/**
	 * 通讯录界面的Fragment
	 */
	private TeachFragment contactsFragment;
	...
	public class MyPagerAdapter extends FragmentPagerAdapter {
		...
		private final String[] titles = { "器材", "教程", "分享" };
		...
		public Fragment getItem(int position) {
			...
			case 1:
				if (foundFragment == null) {
					foundFragment = new ShareFragment();
				}
				return foundFragment;
			case 2:
				if (contactsFragment == null) {
					contactsFragment = new TeachFragment();
				}
